...
<table class="table">
  ...
  <tbody>
   ...
   <tr>
      ...
      <td><input class="countreal" type="number" name="countreal-{{$value->id}}" value="0"></td>
      <td><input class="result" readonly="true" type="number"></td>
    </tr>
   @endforeach

  </tbody>
</table>
   <button class="btn btn-success">Сохранить инвентаризацию</button>
    </form>
<script type="text/javascript">
  $(document).ready(function () {
    $('body .countreal').on('change', function() {
      var parent = $(this).parent().parent();
      var count = -(parent.find('.count').val() - $(this).val());
      parent.find('.result').val(count);
    })
  })
</script>
</div>
